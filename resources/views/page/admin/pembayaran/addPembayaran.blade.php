            ...
            <div class="col-md-6">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Informasi Data Tagihan</h3>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label for="inputLayanan">Jenis Pembayaran</label>
                        ...
                        <div class="form-group">
                            <label for="inputNamaAsisten">Nominal</label>
                            <input
                                type="text"
                                id="inputNamaAsisten"
                                name="nama_asisten"
                        ...
                        <div class="form-group">
                            <label for="inputNamaAsisten">Nomor</label>
                            <input
                                type="text"
                                id="inputNamaAsisten"
                                name="nama_asisten"
